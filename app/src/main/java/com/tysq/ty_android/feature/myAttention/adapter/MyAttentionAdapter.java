package com.tysq.ty_android.feature.myAttention.adapter;
...
import com.tysq.ty_android.feature.myAttention.adapter.viewHolder.ContentViewHolder;
import com.tysq.ty_android.feature.myAttention.adapter.viewHolder.TitleViewHolder;
 ...
 * version      : 1.0.0
 */
public class MyAttentionAdapter extends
        CommonHeaderSimpleAdapter<TitleCountVO, MyAttentionListResp.AttentionInfoBean> {

    private final WeakReference<BitBaseFragment> mFragment;
    private final WeakReference<Context> mContext;
    private MyAttentionClickListener mListener;
    private int userId;

    public MyAttentionAdapter(BitBaseFragment fragment,
                              Context context,
                              TitleCountVO header,
                              List<MyAttentionListResp.AttentionInfoBean> dataList,
                              MyAttentionClickListener listener,
                              boolean isNeedHeader,
                              int userId) {
        super(context, header, dataList, isNeedHeader);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof TitleViewHolder) {
            ...
            String format = String.format(mContext.get()
                    .getString(R.string.my_attention_num), mHeader.getCount());

            titleViewHolder.tvTitle.setText(format);
        } else if (holder instanceof ContentViewHolder) {
            ContentViewHolder contentViewHolder = (ContentViewHolder) holder;

            MyAttentionListResp.AttentionInfoBean attentionInfoBean
            ...
            contentViewHolder.rlFocusSomeOne.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    mListener.onMyAttentionClick(view,
