...
public class TagFlowLayout extends ViewGroup {
    ...
    // 需要显示的行数
    private int mNeedShowLine = SHOW_ALL;
    ...
    public void setNeedShowLine(int needShowLine) {
        this.mNeedShowLine = needShowLine;
    }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        int lineSize = mNeedShowLine == SHOW_ALL ?
                mRowViewList.size() : mNeedShowLine;
